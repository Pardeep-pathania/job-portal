...
useEffect(()=>{
  ...
  return (
    <form className='container p-4 flex gap-3 flex-col w-full items-start'>
      
        <div className='w-full'>
            <p className='mb-2'>Job Title</p>
            <input className='w-full max-w-lg px-3 py-2 border-2 border-gray-300 rounded' type="text" placeholder='Type here' onChange={e=>setTitle(e.target.value)} value={title} />
        </div>
