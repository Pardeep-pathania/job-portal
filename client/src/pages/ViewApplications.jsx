        ...
        <table className="w-full max-w-4xl bg-white border-gray-200 max-sm:text-sm">
          <thead>
            <tr className="border-b">
              ...
              <th className="py-2 px-4 text">User Name</th>
              <th className="py-2 px-4 text max-sm:hidden">Job Title</th>
              <th className="py-2 px-4 text max-sm:hidden">Location</th>
              <th className="py-2 px-4 text">Resume</th>
              ...
              <tr key={index} className="text-gray-700">
                ...
                <td className="py-2 px-4 border-b relative">
                  <div className="relative inline-block text-left group">
                    ...
                    <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bh-white border border-gray-200 rounded shadow group-hover:block">
