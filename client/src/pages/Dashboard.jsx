  ...
  return (
    <div className="min-h-screen">
          ...
          {companyData && (
            ...
            <div className="relative group">
              ...
              <div className="absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-2">
                <ul className="list-none mt-10 p-2 bg-white rounded-md border text-sm">
                  <li onClick={logout} className="py-1 px-2 top-10 cursor-pointer pr-10">
                    Logout
                  </li>
                </ul>
              </div>
      ...
      <div className="flex items-start">
        {/* left sidebar with option to add job, manage job etc */}
